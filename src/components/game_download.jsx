...
function GameDownloadPage() {
    ...
    return (
        <div style={styles.container}>
            ...
            <h1 className="myComicHeader" style={styles.mainHeading}>
                Download CANQUEST
            </h1>
            ...
            <section style={styles.comicPanel}>
                ...
                <ol style={styles.list}>
                    ...
                    <li>Double-click <em>CANQUEST.exe</em> to start the game.</li>
                    <li>Once the server is running, and you are on the same network, you can connect to the server by clicking the in game "Connect" button and entering the server's IP address.</li>
                    <li>After establishing a connection, you can start the game.</li>
                </ol>
            </section>
            <section style={styles.comicPanel}>
                <h2 className="myComicHeader" style={styles.subHeading}>
                ...
                <br />
                <strong>Recommended Specs:</strong> 16GB RAM, Intel i7 or equivalent, 16GB free disk space.
                <br />
                <strong>Performance:</strong> Lowest graphics for best performance.
                </p>
            </section>
        </div>
    );
