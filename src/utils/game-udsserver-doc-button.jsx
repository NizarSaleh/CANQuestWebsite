...
function GameServerDocButtonContainer() {
  const navigate = useNavigate();

  return (
    <div style={styles.buttonContainer}>
      <button style={styles.button} onClick={() => navigate('/game_doc')}>Game</button>
      <button style={styles.button} onClick={() => navigate('/uds-server_doc')}>Server</button>
    </div>
  );
}
...
export default GameServerDocButtonContainer;